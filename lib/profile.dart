...
class _personInfoState extends State<personInfo> {
  ...
  Future person() async {
    idglo = id.text;
    var url = "http://" + IPADDRESS + "/handinhand2/personInfo.php";
...
class _contactInfoState extends State<contactInfo> {
  ...
  Future contact() async {
    ...
    print(Tphone.text);
    print(Mphone.text);
    var url = "http://" + IPADDRESS + "/handinhand2/contactInfo.php";
    var response = await http.post(Uri.parse(url), body: {
      "email": emailglo,
      "TPhone": Tphone.text,
      "MPhone": Mphone.text,
...
class _eduInfoState extends State<eduInfo> {
  ...
  Future education() async {
    var url = "http://" + IPADDRESS + "/handinhand2/eduInfo.php";
    var response = await http.post(Uri.parse(url), body: {
      "email": emailglo,
  ...
  Future JoinToDonors() async {
    try {
      var url = "http://" + IPADDRESS + "/handinhand2/jointodonors.php";
      var response = await http.post(Uri.parse(url), body: {
        "email": emailglo,
      });
      print(response.body);
