...
class MyLocale implements Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          "Pick File": "اختر ملف",
          "ID card of the head of the family, showing the family members:": "بطاقة هوية رب الأسرة ، ظاهراً فيها أفراد الأسرة:",
          ...
          "t1_a": "تقرير طبي مختوم من وزارة الصحة مبين فيه وصف الحالة الخاصة لكل حالة في حال وجود حالات خاصة",
          "t2_a":"شهادة من الشؤون الاجتماعية (حكومة، وكالة) في حال كنت حالة اجتماعية",
          ...
          "t6_a":"شهادة وفاة لكل من (الاب/الزوج) و/او (الام/الزوجة) في حالة الوفاة",
          "t7_a":"شهادة اثبات طالب حديثة لكل طالب جامعي في اسرتك وبالنسبة للاخوة في النجاح صورة الهوية الجامعية فقط",
        ...
        "en": {
          ...
          "ID Card:": "ID Card:",
          "Pick File": "Pick File",
          "ID card of the head of the family, showing the family members:": "ID card of the head of the family, showing the family members:",
          "High school transcripts:": "High school transcripts:",
          "Student Card:": "Student Card:",
          "Transcript for the last semester:": "Transcript for the last semester:",
          "t1_a": "A medical report sealed by the Ministry of Health, showing the description of the special case for each case, if there are any special cases:",
          "t2_a":"Certificate from Social Affairs (government, agency) in case you are a social status:",
          "t3_a":"A legal lease contract for the family residence, if the housing is rented:",
          "t4_a":"Salary slip for father/husband or mother/wife if they are employed:",
          "t5_a":"A legal lease contract for the student housing if the housing is for rent:",
          "t6_a":"Death certificate for (father/husband) and/or (mother/wife) in case of death:",
          "t7_a":"A recent student proof certificate for each university student in your family, and for the brothers in success, a copy of the university ID only:",
          "t1_f":
