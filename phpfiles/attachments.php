...
if ($count == 1) {
    $update = "UPDATE attachments SET idcard='".$idcard."', studentcard='".$studentcard."', lastsemtranscript='".$lastsemtranscript."', stucertificate='".$stucertificate."', fatheridandfammem='".$fatheridandfammem."', medicalreport='".$medicalreport."', socialafairs='".$socialafairs."', legalforhouserented='".$legalforhouserented."', salaryslip='".$salaryslip."', deathcertificate='".$deathcertificate."', stufamuni='".$stufamuni."' WHERE id='".$id."'";
    $query = mysqli_query($mydb,$update);
    echo json_encode("Updated");
}else{
    $insert = "INSERT INTO attachments(id,idcard,studentcard,lastsemtranscript,stucertificate,fatheridandfammem,medicalreport,socialafairs,legalforhouserented,salaryslip,deathcertificate,stufamuni)VALUES('".$id."','".$idcard."','".$studentcard."','".$lastsemtranscript."','".$stucertificate."','".$fatheridandfammem."','".$medicalreport."','".$socialafairs."','".$legalforhouserented."','".$salaryslip."','".$deathcertificate."','".$stufamuni."')";
