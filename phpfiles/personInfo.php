...
if ($count == 1) {
    ...
    $insert = "INSERT INTO person_info(id,email,fname,birthdate,birthplace,city,income,gender,socialstatus)VALUES('".$id."','".$email."','".$fname."','".$birthdate."','".$birthplace."','".$city."','".$income."','".$gender."','".$socialstatus."', flag1='".$flag1."')";
