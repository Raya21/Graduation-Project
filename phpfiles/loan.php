...
///send notifications
$body="A new loan is available now! check your homepage to know more about it.";
...
foreach ($str_arr as $value) {
    ...
    if($count2>0)
    {
        while ($row = $result2->fetch_assoc()) {
            ...
            $insert = "INSERT INTO notifications(email,title,body)VALUES('".$row['email']."','".$lname."','".$body."')";
    ...
    $notification = [
            'title' =>$lname,
            'body' => 'A new loan is available now!',
            'icon' =>'myIcon', 
            'sound' => 'mySound'
        ];
