...
if(isset($_POST['btn_search1'])){
    ...
    $sql = "SELECT COUNT(*) FROM scholarship_request WHERE sname='$search1'";
...
$query1 = "SELECT * FROM scholarship_request";
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                ...
                title:  "No. of scholarship requests"
            };
...
<div class="mane">
    ...
    <script>
        ...
        function drawChart1() {
            ...
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                echo "['No. of scholarships',".$row."],";
                ?>
            ]);

            var options = {

                title:  "No. of scholarships= "+<?php echo $row;?>
            };
    ...
    <div id="piechart2" width="600" height="300" style="background-color: #f00;"></div>
    <?php
    ...
    <div id="piechart3" width="600" height="300" style="background-color: #f00;"></div>
    ...
    if(isset($_POST['btn_search2'])){
        ...
        $sql = "SELECT COUNT(*) FROM loan_request WHERE lname='$search2'";
    ...
    <form action="" method="post">
        ...
        <input type="text" name="search2" class="searchtxt" >
        <input type="submit" name="btn_search2" value="Search" class="search">
    </form>
    <div id="piechart4" width="600" height="300" style="background-color: #f00;"></div>
</div>
<div class="mane">
</body>
</html>
